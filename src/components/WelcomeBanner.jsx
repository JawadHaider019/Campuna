        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[80] w-[calc(100%)] max-w-4xl"
                >
                    <div className="relative flex flex-row items-center gap-2 sm:gap-4 bg-forest/70 backdrop-blur-xl border border-white/10 rounded-[20px] sm:rounded-[28px] px-4 py-3 sm:px-7 sm:py-5 shadow-[0_24px_64px_-12px_rgba(0,99,13,0.45)]">
