...
export default function HeroSection({ onSearch, onExploreClick, onSellClick, searchRef }) {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[80vh] md:min-h-[85vh] flex items-center justify-center overflow-hidden rounded-[24px] sm:rounded-[32px] md:rounded-[40px] lg:rounded-[48px] mt-34 sm:mt-34 md:mt-34 mb-12 mx-4 md:mx-8 lg:mx-12 shadow-2xl border border-forest/10"
    >
